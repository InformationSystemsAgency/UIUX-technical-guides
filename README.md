...
[`coding-style.md`](./coding-style.md) | [`architecture-style.md`](./architecture-style.md) | [`logging-guide.md`](./logging-guide.md) | [`unit-testing-guide.md`](./unit-testing-guide.md) | [`directus-migrations-guide.md`](./directus-migrations-guide.md)
...
- [`directus-migrations-guide.md`](./directus-migrations-guide.md) - Directus migration mechanism, workflow, and safety rules.
...
5. Apply [`directus-migrations-guide.md`](./directus-migrations-guide.md) for all Directus schema/data changes.
